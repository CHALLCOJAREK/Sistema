...
# ============================================================
# 🔐 CARGA DEL ARCHIVO .ENV (VARIABLES DE ENTORNO)
# ============================================================
from dotenv import load_dotenv

# Detectar automáticamente la raíz del proyecto
BASE_DIR = os.path.dirname(os.path.abspath(__file__))       # .../Backend
ROOT_DIR = os.path.abspath(os.path.join(BASE_DIR, ".."))    # .../Sistema
ENV_PATH = os.path.join(ROOT_DIR, "config.env")

# Cargar variables desde config.env si existe
if os.path.exists(ENV_PATH):
    load_dotenv(ENV_PATH)
    print(f"✅ Variables cargadas desde: {ENV_PATH}")
else:
    print(f"⚠️ Archivo config.env no encontrado en {ENV_PATH}")

# ============================================================
# ⚙️ CONFIGURACIÓN BASE
# ============================================================

app = FastAPI(title="REGISTRA PERU – API", version="v3.0")
